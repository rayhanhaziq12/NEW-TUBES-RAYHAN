...
if st.button("🔍 Prediksi Sekarang", use_container_width=True, type="primary"):
    ...
    # ── DEBUG: tampilkan nilai sebelum & sesudah scaling ──
    with st.expander("🔎 Debug: Lihat nilai input & setelah scaling"):
        st.write("**Input asli:**")
        st.dataframe(input_data)
        st.write("**Input setelah scaling:**")
        st.dataframe(pd.DataFrame(input_scaled, columns=FEATURE_COLS))
